...
class ChatBotScreen extends StatelessWidget {
  ChatBotScreen(
      {super.key, this.titleText, this.appBarColor, this.backgroundColor});
    ...
    return Material(
      child: MultiBlocListener(
        listeners: [
          ...
          BlocListener<OpenaiCubit, OpenaiState>(
            listenWhen: (previous, current) =>
                previous.currentOpenAiMessage != current.currentOpenAiMessage &&
          ...
          BlocListener<GoogleSpeechCubit, GoogleSpeechState>(
            ...
            listener: (context, state) {
              ...
              if (state.recordingDataRecognitionController != null) {
                ...
                context.read<GoogleSpeechCubit>().updateCurrentListeningMessage(
                    message: newMessage, isDone: false);
              }
            },
          ),
              ...
              if (!state.isRecognizing) {
                ...
                if (state.currentListeningMessage != null) {
                  ...
                  if (!state.isFinalReconizerText) {
                    context.read<GoogleSpeechCubit>().updateFinalReconizerText(
          ...
          BlocListener<ChatBotScreenCubit, ChatBotScreenState>(
            listener: (context, state) async {
              if (state.needScroll == true && state.savedTextList.isNotEmpty) {
        ...
        child: Builder(builder: (context) {
          return Scaffold(
            ...
            body: BlocBuilder<ChatBotScreenCubit, ChatBotScreenState>(
                            ...
                            child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  return ChatBubbleWidget(
                                    ...
                                    currentMessage: state.savedTextList[index],
