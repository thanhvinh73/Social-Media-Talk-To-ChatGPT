            ...
            child: Column(
              children: [
                ...
                Row(
                  ...
                  children: [
                    _buildStoryCircle("https://cdn2.iconfinder.com/data/icons/ios-7-icons/50/plus-512.png", "Add"),
                    _buildStoryCircle("https://images.theconversation.com/files/232705/original/file-20180820-30593-1nxanpj.jpg?ixlib=rb-1.1.0&q=20&auto=format&w=320&fit=clip&dpr=2&usm=12&cs=strip", "Duy Minh Truong"),
                    _buildStoryCircle("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS7wtRL1f_19R_ctRH1udYnDWzZLp-Ad8K6_g&usqp=CAU", "kaka123"),
                    _buildStoryCircle("https://cdn.pixabay.com/photo/2021/03/13/14/29/capybara-6091872_1280.jpg", "hello mom"),
                  ],
                ),
                SizedBox(height: 10,),
                Container(
                  ...
                  child: ListView.builder(
                    itemCount: 5, // Change this to the number of posts you want to display
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Image(image: NetworkImage("https://www.rainforest-alliance.org/wp-content/uploads/2021/06/capybara-square-1.jpg.optimal.jpg"))
